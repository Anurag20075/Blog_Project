      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Latest <span className="text-emerald-600">Blog Posts</span>
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover insights, stories, and innovations from the world of
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-6 border-b border-gray-200">
              ...
              <div className="flex items-center space-x-6 text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  <Clock size={16} />
                  <span className="text-sm">{blog.reading_time}</span>
                </div>
              </div>
            </div>
